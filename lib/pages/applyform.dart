									 ...
									 Container(
										...
										child: Padding(
											...
											child: Column(
											 ...
											 children:	[
												Text("Applying", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 64.0)),
												SizedBox(
													width:150,
													height:150,
													child: Image.asset("images/celeb.png"),
												),
												Text("It's time to apply!\nRemember, answer honestly and always put your best foot forward.", style: TextStyle(color: Colors.white, fontSize: 24.0))
											]
											)
										),
								),
