...
class LocationState extends State<Location>{
  ...
  return(
    ...
    Scaffold(
      ...
      body: Center(
        child: FutureBuilder(future: UserLocation.getValue(), builder: (context, snapshot){
          if(snapshot.hasData){
            return Center(child: Column(crossAxisAlignment:CrossAxisAlignment.center, MainAxisAlignment.center, children: [
